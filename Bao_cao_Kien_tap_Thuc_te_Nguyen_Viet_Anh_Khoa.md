...
Khi ORS API không khả dụng, hệ thống tự động sử dụng **công thức Haversine** để tính khoảng cách đường chim bay, đảm bảo hệ thống vẫn cung cấp thông tin khoảng cách ngay cả khi không có dữ liệu lộ trình chi tiết [1].
...
Kết quả được hiển thị trên biểu đồ thời gian Chart.js với marker màu đỏ cho các bất thường và trên bảng dữ liệu với nền màu hổ phách [3].
...
Pipeline giảm thiểu hoàn toàn việc nhập liệu thủ công cho bảo dưỡng định kỳ. Hệ thống cũng hỗ trợ phương pháp đồng bộ HTTP POST-based trực tiếp, nhanh hơn vì không cần khởi tạo trình duyệt [2].
...
Hệ thống giải quyết ba bài toán cốt lõi: (1) **Tracking** với Geofencing sử dụng Ray Casting [4] cho phép tự động phát hiện xe ra/vào trạm; (2) **Phát hiện bất thường nhiên liệu** với mô hình Moving Average baseline và ngưỡng phát hiện 20% [5]; và (3) **Tự động hóa bảo dưỡng** với pipeline Playwright cào dữ liệu Odometer từ TTAS [2].

Hệ thống chuyển đổi quy trình quản lý từ thụ động (reactive, dựa trên điện thoại và Excel) sang chủ động (proactive) với dữ liệu thời gian thực, cảnh báo tự động và phát hiện bất thường sớm. Về mặt cá nhân, đợt kiến tập đã giúp sinh viên phát triển kỹ năng giải quyết vấn đề với dữ liệu không hoàn hảo, làm việc liên phòng ban trong môi trường logistics áp lực cao, và ứng dụng kiến thức CS/AI vào bài toán thực tế có quy mô doanh nghiệp.
